...
- لو قالوا لك "سعد" تعرف إنه "أ. سعد القرشي"، "محمد القرشي" = "أ. محمد القرشي"، "محمد الحجيلي" = "أ. محمد الحجيلي"، "منار" = "د. منار سمان"، "وليد" = "د. وليد الحسن"، "حمادي" = "م. حمادي الشعائره"، "علي" = "م. علي الزهراني", "نوال" = "أ. نوال البلوي", "صخر" = "أ. صخر الزهراني"
- تاريخ اليوم: ${new Date().toISOString().slice(0, 10)} — استخدمه لحساب "اليوم" و "بكرا" و "الأسبوع الجاي"
