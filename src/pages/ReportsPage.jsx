      ...
      <div ref={cardRef} style={{
        ...
        <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div style={{ background: CARD.background, borderRadius: CARD.borderRadius, border: `1px solid ${D.border}`, padding: CARD.padding, boxShadow: CARD.boxShadow, marginTop: 12 }}>
            ...
            {['مسار التدريب', 'مسار الفرضيات', 'مسار جمع البيانات', 'مسار التقارير الدورية', 'مسار تقرير الزيارات الاشرافية', 'مسار التذاكر', 'مسار جاهزية الكوادر الصحية', 'مسار لوحة بيانات القيادة والتحكم', 'أخرى'].map((name, i) => {
              const byPath = {}
              tasks.forEach(t => {
...
function ComprehensiveReport({ tasks, hajjReports = [] }) {
  ...
  function shareBrief() {
    ...
    text += `\n📁 *المسارات:*\n`
    const allPaths = ['مسار التدريب', 'مسار الفرضيات', 'مسار جمع البيانات', 'مسار التقارير الدورية', 'مسار تقرير الزيارات الاشرافية', 'مسار التذاكر', 'مسار جاهزية الكوادر الصحية', 'مسار لوحة بيانات القيادة والتحكم', 'أخرى']
